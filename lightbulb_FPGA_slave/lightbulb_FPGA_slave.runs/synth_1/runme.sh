...
HD_PWD='C:/Different/SRIP_2024/Photonics lab/lightbulb_FPGA_slave/lightbulb_FPGA_slave.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log spi_byte.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source spi_byte.tcl
