...
HD_PWD='C:/Different/SRIP_2024/Photonics lab/lightbulb_FPGA_slave/lightbulb_FPGA_slave.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log spi_byte.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source spi_byte.tcl -notrace
